    ...
    <GridItem className={className}>
      <PointerBox caret="left-top" bg="#fafafa">
        ...
        >
          ...
          <Divider />
          {((coveredLines / totalLines) * 100 < threshold ?? -Infinity) && (
            <Text marginY="2">
              ❌ Total statement coverage is less than specified threshold.
              Current coverage is{' '}
          ...
          <Box
            ...
            color="gray.500"
          >
            Status of coverage: 🟢 - ok, 🟡 - slightly more than threshold, 🔴 -
            under the threshold
          </Box>
