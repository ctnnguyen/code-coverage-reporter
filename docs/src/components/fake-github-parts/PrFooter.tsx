...
export const PrFooter = ({ className }: PrFooterProps) => {
  ...
  return (
    <BorderBox className={className} borderRadius={0} borderWidth="3px 0 0 0">
      <Grid templateColumns="60px 1fr" marginTop="2">
        <GridItem
          ...
          display="flex"
        >
          <BorderBox padding={1} bg="bg.warning" borderColor="border.warning">
            <StyledOcticon
              size={24}
        ...
        <GridItem>
          <PointerBox borderColor="border.warning" caret="left-top">
            ...
            <Checks>
              ...
              <CheckItem last>
                <Text ml="2" fontSize="sm">
                  coverage / Tests annotations (🧪 jest-coverage-report-action)
                  (p...
                </Text>
              </CheckItem>
            </Checks>
